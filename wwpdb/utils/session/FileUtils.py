...
class FileUtils(FileUtilsBase):
    ...
    def __setup(self, siteId=None):
        ...
        self.__lfh.write(
            "+FileUtils.__setup() starting with entryId %r adjusted WWPDB_SITE_ID %r\n"
        ...
        for tup in tupL:
            ...
            if displayImageFlag and fN.startswith(entryId + "_img-emdb"):
                ...
                imgHtml = (
                    ...
                    + "/"
                    + fN
                    + '" border="0" alt="Image" width="400" height="400">'
                )
    ...
    def __renderFileList(fileTupleList, title, embeddedTitle=True):
        ...
        if len(fileTupleList) > 0:
            if embeddedTitle:
                ...
                oL.append(
                    '<tr><th class="width50">%s</th><th class="width30">Modification Time</th><th class="width20">Size (KBytes)</th></tr>'
                    % title
                )
            else:
